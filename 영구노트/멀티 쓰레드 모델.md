...
**특징**
많은 [[User Level Thread]]가 하나의 [[Kernel Level Thread|커널 쓰레드]]를 활용함
...
**특징**
각 사용자 스레드와 커널 스레드가 1:1로 연결됨. 쓰레드 관리를 [[User Level Thread]] -> [[Kernel Level Thread|커널 쓰레드]]로 위임하는 역할을 한다
...
- [[User Level Thread|사용자 레벨 쓰레드]]
- [[Kernel Level Thread|커널 레벨 쓰레드]]
- [[GoRoutine 고루틴 소개]]

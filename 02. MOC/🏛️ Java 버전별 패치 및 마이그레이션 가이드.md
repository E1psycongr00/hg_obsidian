...
### JDK 8 (2014-2030)
- [[JDK 8 주요 특징 및 패치 분석]] - 람다 표현식, 스트림 API, PermGen 제거 등 핵심 특징 분석
- [[📚 Oracle JDK 8 공식 문서]] - Oracle 공식 문서 및 릴리즈 노트 요약

### JDK 11 (2018-2026)
- [[JDK 11 주요 특징 및 패치 분석]] - HTTP 클라이언트 API, var 키워드 확장, 모듈 시스템 안정화
- [[📚 Oracle JDK 11 공식 문서]] - 공식 마이그레이션 가이드 및 새로운 기능 소개

### JDK 17 (2021-2029)
- [[JDK 17 주요 특징 및 패치 분석]] - Sealed 클래스, 패턴 매칭, ZGC/Shenandoah 정식 지원
- [[📚 Oracle JDK 17 공식 문서]] - 현대적 Java 개발 표준으로서의 특징과 개선사항

### JDK 21 (2023-2031)
- [[JDK 21 주요 특징 및 패치 분석]] - Virtual Threads, 패턴 매칭 강화, Generational ZGC

...
>[!info] CPU
[CPU](https://ko.wikipedia.org/wiki/%EC%A4%91%EC%95%99_%EC%B2%98%EB%A6%AC_%EC%9E%A5%EC%B9%98)(중앙 처리 장치)는 기억, 연산, 제어 3개의 기능을 처리하는 장치이다.  CPU의 성능은 크게 코어 수와 [[03. Permanent Notes/Area/CPU 클럭 속도|클럭]]을 통해 결정한다.
...
자세한 내용은 [[03. Permanent Notes/Area/CPU 쓰레드(Thread)]]를 참고하자
...
## 연결 노트
- [[03. Permanent Notes/Area/CPU 클럭 속도]]
- [[03. Permanent Notes/Area/CPU 쓰레드(Thread)]]

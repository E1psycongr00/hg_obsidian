...
만약 network 관련 에러가 발생한다면 [[03. Permanent Notes/Area/network (network name) declared as external, but could not be found]] 를 참고하자.
...
## 연결 노트
- [[03. Permanent Notes/Area/InfluxDB 소개]]
- [[03. Permanent Notes/Area/network (network name) declared as external, but could not be found]]

...
>4. 커널이 [[03. Permanent Notes/Area/인터럽트]]나 시스템 콜을 직접 처리 ==> CPU에서 커널 코드가 실행됨
...
## 연결 노트
- down:: [[03. Permanent Notes/Area/인터럽트]]
- down:: [[03. Permanent Notes/Area/시스템 콜]]
- [[03. Permanent Notes/Area/Process 컨텍스트 스위칭]]

...
>여러 스레드가 동시에 접근하면 여러 인스턴스가 생성될 수 있습니다. 멀티스레드 환경에서는 사용하지 마세요.
...
>메모리 가시성 문제를 해결하기 위해 `volatile` 키워드가 반드시 필요합니다. 자세한 내용은 [[싱글톤 패턴 Thread-Safety]] 참조.
...
>[!tip] 가장 권장되는 방법
>대부분의 상황에서 최적의 선택입니다. Thread-safe하면서도 지연 초기화를 지원하고 성능도 우수합니다.
...
>[!tip] 가장 안전한 방법
>리플렉션 공격과 직렬화 문제를 완전히 방지하는 가장 안전한 구현 방법입니다.
